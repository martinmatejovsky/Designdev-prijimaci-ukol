...
<template>
  <article
    class="c-product-card d-flex flex-column h-100 rounded-4 overflow-hidden"
  >
    <div
      class="c-product-card__image d-flex align-items-center justify-content-center overflow-hidden rounded-4"
    >
      <img
        v-if="product.image"
    ...
    <div
      class="c-product-card__body d-flex flex-column p-3 row-gap-2 row-gap-md-3"
    >
      <h2 class="c-product-card__name fs-4 fw-bold">{{ product.name }}</h2>

      <p v-if="product.description" class="c-product-card__description">
        {{ product.description }}
      </p>
      ...
      <a
        ...
        class="c-product-card__reviews fw-bold"
        href="#"
      >
        {{ product.reviews }}
